...
const Footer = () => {
  return (
    <div className="w-full h-[34rem] bg-footerBg bg-opacity-50 p-24" style={styles}>
      <div>
        <div className='flex justify-evenly items-center w-full h-full'>
          <div className='w-1/3 flex flex-col gap-14'>
            <h1 className='text-footertxt font-bold tracking-widest'>SUBSCRIBE</h1>
            <div className='text-footertxt tracking-wide'>Exciting things ahead,<br></br> stay tuned for more information.</div>
            <div className='flex flex-col gap-4'>
              <div>
                <form className='flex gap-4'>
                  <input
                    placeholder='Enter Your Email Adress'
                    className='placeholder-footertxt text-footertxt border-2 border-footertxt px-4 py-2 bg-footerBg bg-opacity-40 focus:outline-none'
                  />
                  <button
                    type='button'
                    className='px-6 py-2 bg-tertiary border-2 border-footertxt text-footertxt font-extrabold' >
                      OK
                  </button>
                </form>
              </div>
          ...
          <div className='self-start w-1/3'>
            <div>
              <h1 className='text-footertxt font-bold tracking-widest'>FIND YOUR WAY</h1>
            </div>
        ...
        <div className='flex justify-around text-footertxt mt-3'>
